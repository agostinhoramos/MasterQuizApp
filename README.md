# Master Quiz Application
## Quiz: Conflict in Ukraine <img src="https://images.emojiterra.com/google/noto-emoji/v2.028/128px/1f1fa-1f1e6.png" width="23px" height="23px">
...
- Why are there so few wars in the 21st century?<br/>
...
...
<p align="center">
	<img src="document/database.png?raw=true" width="100%">
</p>
...
<ul>
    ...
    <li>BroadcastReceivers (Socket.io)</li>
    <li>User Interface Classes</li>
    <li>Multimedia</li>
    <li>User Location</li>
</ul>
